...
class JsonPathLexer(object):
    ...
    def t_singlequote_error(self, t):
        raise JsonPathLexerError('Error on line %s, col %s while lexing singlequoted field: Unexpected character: %s ' %
    ...
    def t_doublequote_error(self, t):
        raise JsonPathLexerError('Error on line %s, col %s while lexing doublequoted field: Unexpected character: %s ' %
                                 (t.lexer.lineno, t.lexpos - t.lexer.latest_newline, t.value[0]))
